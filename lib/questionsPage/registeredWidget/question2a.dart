...
class Question2a extends StatefulWidget {
  @override
  _Question2aState createState() => _Question2aState();
}

class _Question2aState extends State<Question2a> {
  @override
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          child: ListTile(
            title: text(
              text: "Personal Information –Tenant (Official Occupant) - (1/3)",
              size: 16,
              color: WHITE,
              bold: true,
            ),
