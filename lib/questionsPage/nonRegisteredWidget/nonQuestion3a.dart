...
class NonQuestion3a extends StatefulWidget {
  @override
  _NonQuestion3aState createState() => _NonQuestion3aState();
}

class _NonQuestion3aState extends State<NonQuestion3a> {
  @override
        ...
        Container(
          ...
          child: ListView(
            children: <Widget>[
              textFormField(
                hintText:
                    "Type of Business Activity the store/stall owner undertakes (Insert ECG Activity Code)",
                labelText:
                    "Type of Business Activity the store/stall owner undertakes (Insert ECG Activity Code)",
                validate: false,
                icon: null,
              ...
              text(text: "Type of Space", color: BLUE, size: 13),
              DropDown(
                items: space,
                value: "Select",
              ),
              ...
              textFormField(
                hintText:
                    "What is your source of connection? (Example from the next store/stall)",
                labelText:
                    "What is your source of connection? (Example from the next store/stall)",
                validate: false,
                icon: null,
              ...
              text(
                text: "Will you like to have your own connection direct from the utility, with a new meter?",
                color: BLUE,
                size: 13,
              ),
              yesNoRadioBution(),
              ...
              text(
                  text:
                      "How long ago was the internal wiring of your shop/stall undertaken?",
                  color: BLUE,
                  size: 13),
              DropDown(
  ...
  Widget operatorRadioBution() {
    return Column(
      children: <Widget>[
        ListTile(
          title: const Text('Business License Holder',
        ...
        ListTile(
          title: const Text('Other Permitted Occupant',
              style: TextStyle(color: BLUE)),
          leading: Radio(
            activeColor: BLUE,
